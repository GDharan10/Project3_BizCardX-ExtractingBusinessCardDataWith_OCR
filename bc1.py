...
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR ",
                   ...
                   menu_items={'About': """# This OCR app is created by Priyanka*!"""})
...
if selected == "Modify":
    ...
    with col1:
        ...
        cursor.execute("select company_name,card_holder,designation,mobile_number,email,website,area,city,state,pin_code from card_data WHERE card_holder=?",
                        (selected_card,))
        ...
        update_button = st.button("Commit changes to DB")
    ...
    with col2:
        ...
        delete_button = st.button("Yes Delete Business Card")
